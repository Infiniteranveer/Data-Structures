/*
                                                     ...
                                                     ____                                  ____  _             _     
                                                    |  _ \ __ _ _ ____   _____  ___ _ __  / ___|(_)_ __   __ _| |__  
                                                    | |_) / _` | '_ \ \ / / _ \/ _ \ '__| \___ \| | '_ \ / _` | '_ \ 
                                                    |  _ < (_| | | | \ V /  __/  __/ |     ___) | | | | | (_| | | | |
                                                    |_| \_\__,_|_| |_|\_/ \___|\___|_|    |____/|_|_| |_|\__, |_| |_|
                                                                                                         |___/       



                                                                    +-+-+-+-+-+-+-+ +-+-+-+-+-+
                                                                    |R|a|n|v|e|e|r| |S|i|n|g|h|
                                                                    +-+-+-+-+-+-+-+ +-+-+-+-+-+
                
                                                        +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
                                                        |i|n|f|i|n|i|t|e|r|a|n|v|e|e|r|@|g|m|a|i|l|.|c|o|m|
                                                        +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
                                                    ...
                                                    +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
                                                    |h|t|t|p|s|:|/|/|g|i|t|h|u|b|.|c|o|m|/|I|n|f|i|n|i|t|e|r|a|n|v|e|e|r|
                                                    +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+

        Written by : Ranveer Singh
        Gmail      : infiniteranveer@gmail.com
        Github     : https://github.com/Infiniteranveer/ 
